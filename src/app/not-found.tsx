...
export default function NotFoundPage() {
    ...
    return (
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="min-h-screen flex flex-col items-center justify-center p-6">
            ...
            {hydrated && randomMeme ? (
                <Image src={randomMeme} alt="Random Meme" className="mt-6 w-96 h-auto rounded-lg shadow-lg" />
            ) : (
                <Image src="https://media.giphy.com/media/hECJDGJs4hQjjWLqRV/giphy.gif" alt="404 Error GIF" className="mt-6 w-96 h-auto rounded-lg shadow-lg" />
            )}
